...
public enum ModelFile {
    ...
    BERKELEY_ALIGNMENT_DIRECTORY(ModelDirectory.BERKELEY_WORD_ALIGNMENT, ""),
    LANG_MODEL_ARPA(ModelDirectory.LANGUAGE_MODEL, "lang_model.arpa"),
    LANG_MODEL_BIN(ModelDirectory.LANGUAGE_MODEL, "lang_model.bin"),
    TUNER_WEIGHTS(ModelDirectory.TUNER_MODEL, System.getProperty("user.dir") + "/tuning.online.final.binwts"),
